// 콜백 함수는 "분리" 목적이다. ///// () => {}
// arrow expression(function) // 익명함수
...
//     if (callback) {
//         callback(str1 + str2 + "님");
//     }
//     return str1 + str2;
// };
// fullName("김", "규산", (fullname) => {
...
// const prices = (price, sum, callback) => {
//     if (callback) {
//         callback(sum / price <= 5);
//     }
//     return "개수:" + price + "총합:" + sum;
// };

// prices(50, 5000, (result) => {
//     console.log(result);
// });
...
// const post = (price, status, callback) => {
//     if (callback) {
//         callback(status ? "결제완료" : "결제취소");
//     }
//     return price + status;
// };

// post(15000, false, (result) => {
//     console.log(result);
// });
